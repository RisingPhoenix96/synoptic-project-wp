<?php
// Fetch images from the photo catalogue page's gallery field
$catalogue_gallery = get_field('synoptic_catalogue_gallery_images');
?>

<?php if ($catalogue_gallery) : ?>
    <!-- If images exist in gallery then display them -->
    <?php foreach ($catalogue_gallery as $catalogue_image) : ?>
